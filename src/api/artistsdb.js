    ...
    handleAsync(async (req, res) => {
      ...
      if (
        handleDbResponse(
          ...
          error,
          res,
          `Artist with id ${req.params.id} not found`
        )
      )
        return;
    ...
    handleAsync(async (req, res) => {
      ...
      if (
        handleDbResponse(
          ...
          error,
          res,
          `No artists found with last name matching '${req.params.substring}'`
        )
      )
        return;
    ...
    handleAsync(async (req, res) => {
      ...
      if (
        handleDbResponse(
          ...
          error,
          res,
          `No artists found from country matching '${req.params.substring}'`
        )
      )
        return;
